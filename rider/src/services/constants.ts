export let SHOW_VEHICLES_WITHIN = 10; // within 5km
...
export let DEFAULT_AVATAR = "https://marketplace.canva.com/MAB2sqFKHu0/1/thumbnail/canva-business-people-design-person-icon--MAB2sqFKHu0.png";
